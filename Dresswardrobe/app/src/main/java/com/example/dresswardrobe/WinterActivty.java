...
public class WinterActivty extends AppCompatActivity  implements NavigationView.OnNavigationItemSelectedListener  {
    Context c = this;
    List<Images> img;
    List<Images> img2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _fabSingleItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(WinterActivty.this,AddSingleImage.class);
    ...
    public void getmine(){
        ...
        String api_url = "users/Winter?UserName="+username;
        String ja = WCFHandler.GetJsonResult(api_url);
        Log.d("helloo",ja);
        Gson gson = new Gson();
        Type founderListType = new TypeToken<ArrayList<GlobalItems>>(){}.getType();
