...
public class SpecificUsers extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    Context c = this;
    List<Images> img;
    List<Images> img2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tabHost.removeTabAt(1);
        Intent i = getIntent();
        username = i.getStringExtra("uname");
        frname = i.getStringExtra("fname");
        tabHost.getTabAt(0).setTag(frname +"'s Wardrobe");
        getmine();
        getfriend();
        ...
        _fabSingleItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(),AddSingleImage.class);
    ...
    public void getfriend(){
        ...
        String api_url = "users/getFrienditems?UserName="+frname;
        ...
        for(GlobalItems g : it){
            ...
            img.add(new Images(g.ITEM_ID,g.getUSERNAME(), 2, g.getITEM_NAME(),decodedImage,g.getSEASON(),g.getSIZE(),g.getCOLOR(),g.getTYPE()));

        }
    }
    public void getmine(){

        String api_url = "users/getAllitems?UserName="+frname;
        String ja = WCFHandler.GetJsonResult(api_url);
        Gson gson = new Gson();
        Type founderListType = new TypeToken<ArrayList<GlobalItems>>(){}.getType();
        List<GlobalItems> it = gson.fromJson(ja, founderListType);
        ...
        for(GlobalItems g : it){
            ...
            img2.add(new Images(g.ITEM_ID,g.getUSERNAME(), 2, g.getITEM_NAME(),decodedImage,g.getSEASON(),g.getSIZE(),g.getCOLOR(),g.getTYPE()));
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.home:
                ...
                intent3.putExtra("uuname",username);
